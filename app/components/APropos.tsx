    ...
    <section id="apropos" style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: isMobile ? '20px' : '22px', fontWeight: 700, color: '#1a0a02', lineHeight: 1.3, marginBottom: '12px' }}>
            Une passion pour les traditions culinaires de l'Île de Beauté
          </h2>
          <p style={{ fontSize: '13px', lineHeight: 1.8, color: '#5a3a2a', marginBottom: '8px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '16px', paddingTop: '12px', borderTop: '1px solid #e8d5c4' }}>
