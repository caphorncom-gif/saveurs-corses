            ...
            {expositions.map((e) => (
              ...
              >
                <div style={{textAlign: 'center', minWidth: '44px', flexShrink: 0, borderRight: '1px solid #e8d5c4', paddingRight: '12px'}}>
                  <p style={{fontFamily: 'Playfair Display, serif', fontSize: e.jour.length > 2 ? '16px' : '20px', fontWeight: 700, color: '#8b1a1a', lineHeight: 1}}>{e.jour}</p>
                  <p style={{fontSize: '7px', letterSpacing: '1.5px', textTransform: 'uppercase', color: '#a08060', marginTop: '2px'}}>{e.mois}</p>
                </div>
                <div style={{flex: 1, minWidth: 0}}>
                  <p style={{fontSize: '12px', fontWeight: 700, color: '#1a0a02', marginBottom: '2px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>{e.lieu}</p>
                  <p style={{fontSize: '10px', color: '#5a3a2a', lineHeight: 1.4}}>{e.detail}</p>
                </div>
                <span style={{
      ...
      <section id="contact" style={{
        ...
        <div style={{position: 'relative', zIndex: 1, maxWidth: '900px', width: '100%', display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto', maxHeight: '90vh'}}>
          <div>
            ...
            <h2 style={{fontFamily: 'Playfair Display, serif', fontSize: 'clamp(22px, 5vw, 32px)', fontWeight: 700, color: '#f5ebe0', marginBottom: '8px'}}>Une question ?<br />Une commande ?</h2>
            <p style={{fontSize: '13px', color: 'rgba(245,235,224,0.7)', lineHeight: 1.7, maxWidth: '480px'}}>
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px', alignItems: 'start'}}>
            <div style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
              <div style={{display: 'flex', alignItems: 'center', gap: '16px', padding: '14px 16px', background: 'rgba(255,255,255,0.08)', borderRadius: '6px', border: '0.5px solid rgba(255,255,255,0.15)'}}>
                ...
                <div>
                  ...
                  <p style={{fontSize: '10px', color: 'rgba(245,235,224,0.55)', letterSpacing: '2px', textTransform: 'uppercase'}}>Fondateur · Saveurs Corses</p>
                </div>
              </div>
              <div style={{display: 'flex', alignItems: 'center', gap: '16px', padding: '14px 16px', background: 'rgba(255,255,255,0.08)', borderRadius: '6px', border: '0.5px solid rgba(255,255,255,0.15)'}}>
                <div style={{width: '56px', height: '56px', borderRadius: '50%', overflow: 'hidden', flexShrink: 0, border: '2px solid rgba(255,255,255,0.2)'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '10px', padding: '14px 18px', background: 'rgba(255,255,255,0.08)', borderRadius: '6px', border: '0.5px solid rgba(255,255,255,0.15)'}}>
                <div style={{display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', color: '#f5ebe0'}}>
                ...
                <div style={{display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', color: 'rgba(245,235,224,0.7)'}}>
            ...
            <form style={{display: 'flex', flexDirection: 'column', gap: '8px'}}>
              <input type="text" placeholder="Votre nom" style={{width: '100%', padding: '11px 14px', fontSize: '13px', background: 'rgba(255,255,255,0.08)', border: '0.5px solid rgba(255,255,255,0.2)', color: '#f5ebe0', borderRadius: '4px', outline: 'none', boxSizing: 'border-box'}} />
              <input type="email" placeholder="Votre e-mail" style={{width: '100%', padding: '11px 14px', fontSize: '13px', background: 'rgba(255,255,255,0.08)', border: '0.5px solid rgba(255,255,255,0.2)', color: '#f5ebe0', borderRadius: '4px', outline: 'none', boxSizing: 'border-box'}} />
              <input type="text" placeholder="Sujet" style={{width: '100%', padding: '11px 14px', fontSize: '13px', background: 'rgba(255,255,255,0.08)', border: '0.5px solid rgba(255,255,255,0.2)', color: '#f5ebe0', borderRadius: '4px', outline: 'none', boxSizing: 'border-box'}} />
              <textarea placeholder="Votre message..." rows={3} style={{width: '100%', padding: '11px 14px', fontSize: '13px', background: 'rgba(255,255,255,0.08)', border: '0.5px solid rgba(255,255,255,0.2)', color: '#f5ebe0', borderRadius: '4px', outline: 'none', resize: 'none', boxSizing: 'border-box'}} />
              <button type="submit" style={{alignSelf: 'flex-start', padding: '11px 28px', fontSize: '11px', fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', color: '#fff', background: '#8b1a1a', border: 'none', borderRadius: '4px', cursor: 'pointer'}}>
                Envoyer le message
              </button>
            </form>
          </div>
